...
func (helper *AstHelper) GetTypeUsed(name *ast.Ident) types.Object {
	return helper.typesInfo.Uses[name]
}

func (helper *AstHelper) GetTypeDef(name *ast.Ident) types.Object {
	return helper.typesInfo.Defs[name]
}
